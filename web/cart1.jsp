...
<div class="topnav">
  ...
  <div class="login-container">
    ...
    <center>
        <div class="label">
        <br><font size="4" color="black">CART</font><br><br>   
    ...
    try
    {
        ...
        ResultSet rs2=st2.executeQuery("select * from Cartview;");
    ...
    <table>
        ...
        <form action="ClearCartServ" method="post">
               
                   
            
           &nbsp&nbsp&nbsp&nbsp <input type="submit" value="Clear Cart">
           ...
           &nbsp&nbsp&nbsp&nbsp <input type="submit" value="Payment & Check-Out">
          ...
          <%
            ...
            String cleared = (String)request.getAttribute("clear");
