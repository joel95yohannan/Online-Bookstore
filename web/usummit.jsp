<%-- 
    Document   : usummit
    Created on : Nov 16, 2020, 2:22:10 AM
...
<div>
    ...
    <br><u><font size="4" color="black"><a class="active" href="ufrontpage.jsp">Categories</a></u> - <u><a class="active" href="umathematics.jsp">Mathematics</a></u>
     - <u><a class="active" href="usummit.jsp">Summit Math Algebra 1 Book 7 By Alex Joujan</a></u></font><br><br>
                
            <br><br>
            &nbsp
            
            <form action="SumServ" method="post">
                <br><br>  
           ...
           &nbsp&nbsp&nbsp&nbsp Price: $12.00 
            <% 
                ...
                session.setAttribute("sumisbn", "ISBN-10: 1284045309");
                session.setAttribute("sumname", "Summit Math Algebra 1 Book 7 By Alex Joujan");
                session.setAttribute("sumprice", "12");
