<%-- 
    ...
    Created on : Nov 8, 2020, 11:02:07 PM
...
<div>
    ...
    <br><u><font size="4" color="black"><a class="active" href="frontpage.jsp">Categories</a></u> - <u><a class="active" href="mathematics.jsp">Mathematics</a></u></font><br><br>
            ...
            <form action="engg.jsp" method="post">
            ...
            <br>
            <div class="img">
            <form action="summit.jsp" method="post">
