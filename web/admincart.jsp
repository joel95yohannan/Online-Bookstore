...
<div class="topnav">
  ...
  <div class="login-container">
    ...
    <center>
        <div class="label">
        <br><font size="4" color="black">Purchase registery</font><br><br>   
    ...
    try
    {
        ...
        ResultSet rs=st.executeQuery("select * from adminCart;");
        ResultSet rs2=st2.executeQuery("select * from Admincartview;");
