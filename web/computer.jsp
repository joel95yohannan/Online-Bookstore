<%-- 
    Document   : computer
    Created on : Nov 8, 2020, 6:38:20 PM
...
<div>
    ...
    <br><u><font size="4" color="black"><a class="active" href="frontpage.jsp">Categories</a></u> - <u><a class="active" href="computer.jsp">Computer</a></u></font><br><br>
            ...
            <form action="beginners.jsp" method="post">
            ...
            <br>
            <div class="img">
            <form action="distilled.jsp" method="post">
