<%-- 
    Document   : uhealthcare
    Created on : Nov 16, 2020, 2:20:11 AM
...
<div>
    ...
    <br><u><font size="4" color="black"><a class="active" href="ufrontpage.jsp">Categories</a></u> - <u><a class="active" href="ubigdata.jsp">BigData</a></u>
     - <u><a class="active" href="uhealthcare.jsp">BigData in Healthcare By Farrokh Alemi</a></u></font><br><br>
                
            <br><br>
            &nbsp
            
            <form action="HelServ" method="post">
                <br><br>  
                &nbsp&nbsp&nbsp&nbsp <img src="bdh.JPG" width="150" height="200"><br>
               &nbsp&nbsp&nbsp&nbsp ISBN-10: 1284045305<br>
           &nbsp&nbsp&nbsp&nbsp Price: $90.00 
            <% 
                
                session.setAttribute("helisbn", "ISBN-10: 1284045305");
                session.setAttribute("helname", "BigData in Healthcare By Farrokh Alemi");
                session.setAttribute("helprice", "90");
